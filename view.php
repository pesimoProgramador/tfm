...
$PAGE->set_url('/mod/tfm/view.php', array('id' => $cm->id));
...
if ($alumno) {
    ...
    if ($tfm->examen_activado == 0) {
        echo "
        <li class='li'><a href='view.php?id={$id}'>Empezar examen</a></li>
        ";
    } else {
        echo "
        <li class='li'><a href='examen_alumno.php?id={$id}'>Empezar examen</a></li>
        ";
    }
    echo " 
    </ul>
