...
$id_documento = optional_param('id_documento', 0, PARAM_TEXT);
...
$PAGE->set_url('/mod/tfm/nuevo_examen.php', array('id' => $cm->id));
...
if (!$alumno) {
    ...
    <?php
    if ($tfm->id_documento == '') {
        $nombre_examen = $tfm->id . "_" . $tfm->course . "_" . $tfm->name;
        ?>
        <script type="text/javascript">
            var id = <?php echo json_encode($id) ?>;
            var nombre_examen = <?php echo json_encode($nombre_examen)?>;
        ...
        <script type="text/javascript" src="<?php echo $CFG->wwwroot?>/mod/tfm/js/nuevo_examen.js"></script>
        <?php
        echo "
        <div>
