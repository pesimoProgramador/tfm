...
$PAGE->set_url('/mod/tfm/desactivar_examen.php', array('id' => $cm->id));
...
if (!$alumno) {
    ...
    if ($tfm->examen_activado == 1) {
        ...
        <script type="text/javascript" src="<?php echo $CFG->wwwroot?>/mod/tfm/js/desactivar_examen.js"></script>
        <?php
        echo "
        <div id='div_interfaz'>
        ...
        if ($tfm->examen_activado == 0) {
            ...
            echo "
            <li class='li'><a class='active' href='desactivar_examen.php?id={$id}'>Desactivar examen</a></li>
            ";
        }
        echo "
            ...
            <div id='div_invitados'>
				<h3>Espere a que se desactive el examen</h3>
            </div>
    ...
    echo "
        ...
        <h3>El examen está desactivado</h3>
        </div>
    ";
    }
}
