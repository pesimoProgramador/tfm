...
$actividades = $DB->get_records('tfm', array('course' => $course->id, 'examen_activado_primera_vez' => 1 , 'examen_activado' => 0));
$actividades_array = array_values($actividades);

// Print the page header.

$PAGE->set_url('/mod/tfm/estadisticas.php', array('id' => $cm->id));
...
<script type="text/javascript" src="<?php echo $CFG->wwwroot?>/mod/tfm/js/zingchart.min.js"></script>
<script type="text/javascript" src="<?php echo $CFG->wwwroot?>/mod/tfm/js/estadisticas.js"></script>
<?php
    echo "
    <div id='div_interfaz'>
        <div>
        ...
        echo "
            ...
            <li class='li'><a class='active' href='estadisticas.php?id={$id}'>Estadísticas</a></li>
